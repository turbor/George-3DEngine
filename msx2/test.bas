...
230 IF A$="X" THEN Q$="ANGLE X-AXIS ("+STR$(GX)+")":GOSUB 20000:GX=QQ
240 IF A$="Y" THEN Q$="ANGLE Y-AXIS ("+STR$(GY)+")":GOSUB 20000:GY=QQ
250 IF A$="Z" THEN Q$="ANGLE Z-AXIS ("+STR$(GZ)+")":GOSUB 20000:GZ=QQ
320 IF A$="V" THEN Q$="VERTICAL POS DY ("+STR$(DY)+")":GOSUB 20000:DY=QQ
330 IF A$="H" THEN Q$="HORIZONT.POS DX ("+STR$(DX)+")":GOSUB 20000:DX=QQ
340 IF A$="C" THEN Q$="FACES OVER CP ("+STR$(CP)+")":GOSUB 20000:CP=QQ
355 IF A$="P" THEN GOSUB 2400
356 IF A$="F" THEN GOSUB 2398:GOTO 210
357 IF A$="B" THEN CLS:GOTO 10
370 IF A$="E" THEN Q$="FISHEYE FS ("+STR$(FS)+")":GOSUB20000:FS=QQ
390 IF A$="M" THEN Q$="ZOOM L ("+STR$(L)+")":GOSUB20000:L=QQ
